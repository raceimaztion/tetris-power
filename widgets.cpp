...
{
#ifdef DEBUG
//	printf("Information: wDrawText(): Drawing '%s'\n", text.c_str());
#endif
	if (font == NULL)
	{
...
#ifdef DEBUG
//	printf("Information: wDrawText(): Finished drawing text.\n");
#endif
}
...
{
#ifdef DEBUG
	printf("Information: Label::paint(): Drawing a label.\n");
#endif
...
#ifdef DEBUG
	printf("Information: Label::paint(): Finished drawing a label.\n");
#endif
}
...
void Button::paint() const
{
	...
	if (usedDepth) glEnable(GL_DEPTH_TEST);
#ifdef DEBUG
	printf("Information: Button::paint(): Finished drawing a Button.\n");
#endif
}
...
void Panel::paint() const
{
									   ...
									   cur++)
	{
		if ((*cur) == NULL)
		{
			printf("Error: Panel::paint(): One child of this panel is NULL!\n");
		}
		else
		{
			(*cur)->paint();
	...
	if (usedDepth) glEnable(GL_DEPTH_TEST);
#ifdef DEBUG
	printf("Panel::paint(): Finished drawing panel.\n");
#endif
}
